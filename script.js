// ===================================================================
//              URL FINAL ANDA SUDAH DIMASUKKAN
// ===================================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event listener saat nama diklik
    ...
    // Fungsi untuk menampilkan halaman pemilihan foto
    ...
    // Event listener saat foto dipilih
    ...
    // --- LOGIKA PENGIRIMAN DATA DENGAN WORKAROUND ---
    form.addEventListener('submit', e => {
        e.preventDefault();
        tombolKirim.disabled = true;
        tombolKirim.textContent = 'Mengirim...';

        // Kirim data di latar belakang dan jangan pedulikan jawabannya ("Fire and Forget")
        fetch(scriptURL, { method: 'POST', body: new FormData(form) });

        // Ini adalah WORKAROUND. Kita tidak menunggu jawaban server.
        // Langsung anggap berhasil dan tampilkan halaman "Terima Kasih" setelah 1.5 detik.
        setTimeout(() => {
            halamanFoto.classList.add('hidden');
            halamanTerimaKasih.classList.remove('hidden');
        }, 1500); // Tunggu 1.5 detik untuk memberi waktu data terkirim
    });
    // ---------------------------------------------
