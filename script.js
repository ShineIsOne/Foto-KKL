...
const scriptURL = 'https://script.google.com/macros/s/AKfycbxnGq8weSgN9S1Og-u6MBmb0HAgCjg8FSotM816cURARdKCbDt2o0von844-oMCAZS5jA/exec';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', e => {
        ...
        fetch(scriptURL, { method: 'POST', body: new FormData(form)})
            .then(response => {
                // Kita akan memeriksa respons untuk memastikan itu bukan redirect
                if (response.ok && !response.redirected) {
                    ...
                    throw new Error('Gagal mengirim data, terjadi pengalihan (redirect).');
                }
            })
            .then(data => {
            ...
            .catch(error => {
                ...
                alert("Gagal mengirim data. Coba lagi atau hubungi panitia. Cek console untuk detail.");
                tombolKirim.disabled = false;
